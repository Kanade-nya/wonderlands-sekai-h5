...
const openImageViewer = (event) => {
	...
	const imageTitle = 'Example Image';
	const imageDescription = 'This is an example image description.';

	const url = `/image/viewer?url=${encodeURIComponent(imageUrl)}&title=${encodeURIComponent(imageTitle)}&description=${encodeURIComponent(imageDescription)}`;
